...
module.exports = {
    name: "bot-creation",
    category: "🔰 Info",
    aliases: ["botcreation", "b", "cmd"],
    cooldown: 4,
    usage: "help [Command]",
    description: "Returns bot creation cmds",
      ...
      try{
        if (args[0]) {
          ...
          try {
            ...
            embed2.setTitle(`Bot Creator Commands`)
            embed2.setDescription("These are the Commands, which creates you a Bot!" + botcreation_cmds.join(", "))
            embed2.setFooter(`To see command descriptions and inforamtion, type: ${config.prefix}help [Command]`, client.user.displayAvatarURL());
